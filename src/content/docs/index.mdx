---
title: Installation
description: Getting started with ardacity
icon: ListStart
---
...
```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ardacity/r/utils.json
```
...
```jsx
import Card05 from "@/components/ardacity/card-05";
 ...
 */
import AICardGeneration from "@/components/ardacity/AICardGeneration";
